  ...
  const handleLogout = async () => {
    ...
    try {
      ...
      if (!refreshToken || !accessToken) {
        setErrorMessage("Tokens are missing. Please log in again.");
      ...
      setErrorMessage(error.response?.data?.detail || "Logout failed. Please try again.");
    }
  };

  if (errorMessage) {
    return <div>{errorMessage}</div>; // Display error message if available
  }
